...
import static servlets.RegistroReceptorServlet.message;

/**
 *
 * @author juans
 */
@WebServlet(name = "UpdateReceptorServlet", urlPatterns = {"/updateReceptor"})
public class UpdateReceptorServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        Receptor receptor = new Receptor(Integer.parseInt(request.getParameter("receptor")),
